  ...
  <div class="px-8 w-full overflow-auto">
    <table class="w-full">
      <thead>
        <tr>
          <th
            class="px-4 py-3 text-left bg-slate-100 text-slate-500 font-normal border-solid rounded-tl-md hover:cursor-pointer select-none"
            @click="emit('sort-table', 'name')"
          >
            Name
          </th>
          <th
            class="px-4 py-3 text-left bg-slate-100 text-slate-500 font-normal hover:cursor-pointer select-none"
          ...
          <th
            class="px-4 py-3 text-right bg-slate-100 text-slate-500 font-normal border-solid rounded-tr-md select-none"
          >
            Action
          </th>
        </tr>
